...
public class UpgradResponseStatusException extends ResponseStatusException {
  ...
  public UpgradResponseStatusException(
  ...
  public static UpgradResponseStatusException asConstraintViolation(
      ConstraintViolationException e) {

    return new UpgradResponseStatusException(HttpStatus.BAD_REQUEST, e.getMessage(), e);
  }

  public static UpgradResponseStatusException asExceptionFromHttpStatus(
